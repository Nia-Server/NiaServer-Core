...
一个基于BDS的基岩版服务器，这里开源了由服务器开发团队制作的addons（包括基于script-api的脚本）、大部分运行于LiteLoader的插件（部分LiteLoader插件可以点击前往 [@jiansyuan](https://github.com/jiansyuan/NIAServerPlugin) 查看）
